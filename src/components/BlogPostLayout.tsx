      ...
      <article className="container-x py-12 max-w-3xl prose-trade">
        ...
        <div className="mt-12 p-6 border-l-4 border-brand-accent bg-brand-cream">
          ...
          <p className="text-brand-charcoal mb-4">
            Call our counter at <a href={`tel:${SITE.phoneRaw}`} className="text-brand-blue font-semibold underline">{SITE.phone}</a> or visit us at {SITE.address}, {SITE.city} {SITE.state} {SITE.zip}. Mon–Fri 7am–4pm, Sat 8am–1pm (closed Sat Memorial Day–Labor Day).
          </p>
