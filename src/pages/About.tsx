    ...
    <>
      ...
      <section className="container-x py-20 grid lg:grid-cols-2 gap-12">
        <div className="prose-trade">
          <h2 className="h-section text-brand-blue-dark mb-5">Built for the Trade — Not the Weekend Warrior.</h2>
          <p>TPS Supply is a wholesale plumbing supply house. We sell to plumbers, builders, GCs, property managers, masons, and restaurant operators across Morris County and beyond. We don't try to be everything to everyone. We try to be the one phone call you make when the job has to keep moving.</p>
